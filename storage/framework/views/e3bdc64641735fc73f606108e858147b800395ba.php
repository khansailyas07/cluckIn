<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid">
        <?php if(Auth::user()->type == 1 || in_array(0, explode(',',Helper::get_roles()))): ?>
            <?php echo $__env->make('admin.plugin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <div class="row">
                <div class="col-md-12">
                    <div class="row">
                            ...
                            <div class="card border-0 box-shadow h-100">
                                <div class="card-body">
                                    <div class="dashboard-card">
                                        ...
                                        <span class="text-end">
                                            <p class="text-muted fw-medium mb-1"><?php echo e(trans('labels.categories')); ?></p>
                            ...
                            <div class="card border-0 box-shadow h-100">
                                <div class="card-body">
                                    <div class="dashboard-card">
                                        ...
                                        <span class="text-end">
                                            <p class="text-muted fw-medium mb-1"><?php echo e(trans('labels.items')); ?></p>
                            ...
                            <div class="card border-0 box-shadow h-100">
                                <div class="card-body">
                                    <div class="dashboard-card">
                                        ...
                                        <span class="text-end">
                                            <p class="text-muted fw-medium mb-1"><?php echo e(trans('labels.customers')); ?></p>
                            ...
                            <div class="card border-0 box-shadow h-100">
                                <div class="card-body">
                                    <div class="dashboard-card">
                                        ...
                                        <span class="text-end">
                                            <p class="text-muted fw-medium mb-1"><?php echo e(trans('labels.drivers')); ?></p>
                            ...
                            <div class="card border-0 box-shadow h-100">
                                <div class="card-body">
                                    <div class="dashboard-card">
                                        ...
                                        <span class="text-end">
                                            <p class="text-muted fw-medium mb-1"><?php echo e(trans('labels.reviews')); ?></p>
                            ...
                            <div class="card border-0 box-shadow h-100">
                                <div class="card-body">
                                    <div class="dashboard-card">
                                        ...
                                        <span class="text-end">
                                            <p class="text-muted fw-medium mb-1"><?php echo e(trans('labels.earnings')); ?></p>
                            ...
                            <div class="card border-0 box-shadow h-100">
                                <div class="card-body">
                                    <div class="dashboard-card">
                                        ...
                                        <span class="text-end">
                                            <p class="text-muted fw-medium mb-1"><?php echo e(trans('labels.tax')); ?></p>
            ...
            <div class="row">
                ...
                <div class="col-12 mb-3">
                    <div class="card border-0 box-shadow h-100">
                        <div class="card-body">
                            <h5 class="card-title"><?php echo e(trans('labels.today_order')); ?></h5>
                ...
                <div class="col-md-6 mb-3">
                    <div class="card border-0 box-shadow h-100">
                        <div class="card-body">
                            <h5 class="card-title"><?php echo e(trans('labels.top_items')); ?></h5>
                ...
                <div class="col-md-6 mb-3">
                    <div class="card border-0 box-shadow h-100">
                        <div class="card-body">
                            <h5 class="card-title"><?php echo e(trans('labels.top_users')); ?></h5>
...
<?php echo $__env->make('admin.theme.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/single-restaurant/resources/views/admin/dashboard/home.blade.php ENDPATH**/ ?>