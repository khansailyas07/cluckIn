<header class="page-topbar">
        ...
        <div class="top-header">
            <div class="container">
                <div class="d-block d-md-flex justify-content-center align-items-center">
                    <p class="text-center mb-0"> <a href="https://1.envato.market/zaoZ4r" target="_blank" class="fs-7 text-white">This is a demo website - Buy genuine Single Restaurant we using our official link! Click Now >>> Buy Now</a></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="navbar-header">
        <div class="">
            <button class="navbar-toggler d-lg-none d-md-block px-md-4 px-3" type="button" data-bs-toggle="collapse" data-bs-target="#sidebarcollapse" aria-expanded="false" aria-controls="sidebarcollapse">
        ...
        <div class="px-md-3 px-0 d-flex align-items-center">
            ...
            <div class="position-relative mx-1">
                <div class="dropdown d-lg-block d-none">
                    <a class="btn btn-sm border-primary dropdown-toggle" href="javascript:void(0)" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <img src="<?php echo e(helper::image_path(session()->get('flag'))); ?>" alt="" class="mx-1 rounded-5 language-width">
                    ...
                    <ul class="dropdown-menu drop-menu <?php echo e(session()->get('direction') == 2 ? 'drop-menu-rtl' : 'drop-menu'); ?>">
                        ...
                        <li>
                            <a class="dropdown-item d-flex text-start d-flex" href="<?php echo e(URL::to('/language-'.$lang->code)); ?>">
                                <img src="<?php echo e(helper::image_path($lang->image)); ?>" alt="" class="img-fluid mx-1 rounded-5 language-width">
                ...
                <div class="dropdown d-block d-lg-none">
                    <a class="btn text-dark border dropdown-toggle px-3 py-1 fs-6" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <ul class="dropdown-menu <?php echo e(session()->get('direction') == '2' ? 'min-dropdown-rtl' : 'min-dropdown'); ?>" aria-labelledby="dropdownMenuButton1">
                        <?php $__currentLoopData = Helper::language(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li><a class="dropdown-item text-dark d-flex" href="<?php echo e(URL::to('/language-'.$lang->code)); ?>"><img src="<?php echo e(Helper::image_path($lang->image)); ?>" class="img-fluid lag-img mx-1 rounded-5 language-width" alt=""><?php echo e($lang->name); ?></a></li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </ul>
                </div>
                <!-- language-btn -->
...
</header><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/single-restaurant/resources/views/admin/theme/header.blade.php ENDPATH**/ ?>